...
from OnePieceBot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          dispatcher, StartTime, telethn, updater)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from OnePieceBot.modules import ALL_MODULES
from OnePieceBot.modules.helper_funcs.chat_status import is_user_admin
from OnePieceBot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("OnePieceBot.modules." +
                                              module_name)
